        ...
        <div class="swiper-container news-container">
          <div class="swiper-wrapper news-wrapper">
            ...
            >
              ...
              <div class="swiper_text">{{formatTitle(item.title)}}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="header-container">
        ...
        <div class="header-title">
          <span
            ...
            @click="checkSpan('recommand')"
          >推荐</span>
          <span :class="{checked_span:checkedSpan==='newest'}" @click="checkSpan('newest')">最新</span>
        </div>
      </div>
      <recruit-item
        :item="item"
...
export default {
  ...
  methods: {
    ...
    goToFamous() {
      location.href =
        "https://faxian.lagou.com/discover/d6597003965f41a792744f3c452c7ca9.html";
    },
    goToResume() {
      location.href =
        "https://faxian.lagou.com/discover/dee0163af8b548d8a7cb064d97866ff6.html";
    },
    goToInterview() {
      location.href =
        "https://faxian.lagou.com/discover/f2f913cc86e5488ea48c5b753b0ee9b7.html";
    },
    //职位跳转
    goToRecruit() {
